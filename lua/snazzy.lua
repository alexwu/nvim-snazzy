...
function snazzy.load_syntax()
  local syntax = {
    ...
    PmenuSelBold = {fg=snazzy.green,bg=snazzy.ui_9,sp=snazzy.ui_9,style='bold'};
    ...
    TabLineFill = {fg=snazzy.ui_12,bg=snazzy.ui_9,sp=snazzy.ui_9,style='bold'};
    TabLineSel = {fg=snazzy.ui_2, bg=snazzy.ui_11,sp=snazzy.ui_11,style='bold'};
    StatusLine = {fg=snazzy.fg,bg=snazzy.ui_9,sp=snazzy.ui_9,style=snazzy.none};
    StatusLineNC = {fg=snazzy.ui_4,bg=snazzy.ui_9,sp=snazzy.ui_9,style=snazzy.none};
    ...
    VisualNOS = {fg=snazzy.ui_12,bg=snazzy.ui_1,sp=snazzy.ui_1,style='underline'};
